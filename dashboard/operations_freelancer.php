...
#pagination	
	...
	$orderCountQuery = $pdo->prepare("SELECT COUNT(*) as count FROM orders WHERE freelancer_id=:id AND verification_status=1");
	...
	$ordersQuery = $pdo->prepare("SELECT jobs.job_id, jobs.job_price, jobs.job_title, jobs.job_description,
										...
										WHERE freelancer_id=:id AND orders.verification_status = 1
